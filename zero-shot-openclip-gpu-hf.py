...
if dataset_name == "cifar100":
    dataset = load_dataset("clip-benchmark/wds_vtab-cifar100")
    ...
    dataset = load_dataset("clip-benchmark/wds_sun397")
    ...
    dataset = load_dataset("clip-benchmark/wds_imagenet-o")
    train_available = False
elif dataset_name == "pets":
    dataset = load_dataset("clip-benchmark/wds_vtab-pets")
elif dataset_name == "imagenet-a":
    dataset = load_dataset("clip-benchmark/wds_imagenet-a")
    train_available = False
